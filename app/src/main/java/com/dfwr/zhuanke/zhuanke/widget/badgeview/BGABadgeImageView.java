...
package com.dfwr.zhuanke.zhuanke.widget.badgeview;
 ...
 * 描述:
 */
public class BGABadgeImageView extends AppCompatImageView implements BGABadgeable {
    ...
    public BGABadgeViewHelper getmBadgeViewHeler() {
